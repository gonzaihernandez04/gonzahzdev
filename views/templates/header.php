...
<div class="header__foto">
    <picture>
       <source srcset="/public/build/img/fotopersonal.webp" type="image/webp">
       <img src="/public/build/img/fotopersonal.jpg" alt="Imagen personal" loading="lazy">
    </picture>
</div>

<div class="header__data">
    <div class="header__nombre">
       <h1>Gonzalo Iván Hernández <span class="shake block">👋🏼</span></h1>
    </div>
